package me.HHA.shafferhack.features.modules.render;
...
import me.HHA.shafferhack.util.RotationUtil;
...
public class HoleESP
    ...
    public HoleESP() {
        super("HoleESP", "Shows safe spots.", Category.SHAFFER, false, false, false);
        this.setInstance();
    }
    ...
    public void onRender3D(Render3DEvent event) {
        ...
        for (BlockPos pos : shafferhack.holeManager.getSortedHoles()) {
            ...
            if (pos.equals(new BlockPos(HoleESP.mc.player.posX, HoleESP.mc.player.posY, HoleESP.mc.player.posZ)) && !this.ownHole.getValue().booleanValue() || !RotationUtil.isInFov(pos))
                continue;
            if (this.safeColor.getValue().booleanValue() && shafferhack.holeManager.isSafe(pos)) {
