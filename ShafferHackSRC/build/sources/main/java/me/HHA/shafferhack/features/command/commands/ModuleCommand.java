...
import me.HHA.shafferhack.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : shafferhack.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : shafferhack.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = shafferhack.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = shafferhack.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
