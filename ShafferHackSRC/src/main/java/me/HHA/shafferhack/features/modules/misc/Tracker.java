...
import me.HHA.shafferhack.event.events.DeathEvent;
...
import me.HHA.shafferhack.util.TextUtil;
...
public class Tracker
    ...
    public Tracker() {
        super("Duel", "Tracks players in 1v1s.", Module.Category.OLD, true, false, false);
        instance = this;
    }
