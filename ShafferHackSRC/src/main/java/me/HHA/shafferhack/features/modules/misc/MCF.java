...
public class MCF
    ...
    public MCF() {
        super("MCF", "Middleclick Friends.", Category.SHAFFER, true, false, false);
    }
    ...
    private void onClick() {
        ...
        if (result != null && result.typeOfHit == RayTraceResult.Type.ENTITY && (entity = result.entityHit) instanceof EntityPlayer) {
            if (shafferhack.friendManager.isFriend(entity.getName())) {
                shafferhack.friendManager.removeFriend(entity.getName());
                Command.sendMessage(ChatFormatting.RED + entity.getName() + ChatFormatting.RED + " has been unfriended.");
            } else {
                shafferhack.friendManager.addFriend(entity.getName());
