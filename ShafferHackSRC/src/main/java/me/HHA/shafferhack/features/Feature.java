package me.HHA.shafferhack.features;
...
import me.HHA.shafferhack.manager.TextManager;
...
public class Feature
    ...
    public TextManager renderer = shafferhack.textManager;
    private String name;
    ...
    public Setting register(Setting setting) {
        ...
        if (this instanceof Module && Feature.mc.currentScreen instanceof shafferhackGui) {
            shafferhackGui.getInstance().updateModule((Module) this);
        }
        return setting;
    }
