...
import me.HHA.shafferhack.util.BlockUtil;
...
public class Skeleton
    ...
    public Skeleton() {
        super("Skeleton", "Draws a skeleton inside the player.", Module.Category.OLD, false, false, false);
    }
    ...
    private void drawSkeleton(Render3DEvent event, EntityPlayer e) {
        ...
        if (entPos != null && e.isEntityAlive() && !e.isDead && e != Skeleton.mc.player && !e.isPlayerSleeping()) {
            ...
            if (shafferhack.friendManager.isFriend(e.getName())) {
