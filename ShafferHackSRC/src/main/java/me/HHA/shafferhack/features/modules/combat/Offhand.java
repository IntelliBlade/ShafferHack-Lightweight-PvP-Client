package me.HHA.shafferhack.features.modules.combat;

import me.HHA.shafferhack.event.events.PacketEvent;
import me.HHA.shafferhack.event.events.ProcessRightClickBlockEvent;
import me.HHA.shafferhack.features.modules.Module;
import me.HHA.shafferhack.features.setting.Setting;
import me.HHA.shafferhack.util.EntityUtil;
...
public class Offhand
    ...
    public Setting<Integer> actions = this.register(new Setting<Integer>("Packets", 4, 1, 40));
    ...
    public Offhand() {
        super("Offhand", "Allows you to switch up your Offhand.", Category.SHAFFER, true, false, false);
        instance = this;
    }
