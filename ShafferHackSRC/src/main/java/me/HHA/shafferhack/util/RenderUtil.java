...
public class RenderUtil
    ...
    public static void drawText(BlockPos pos, String text) {
        ...
        GlStateManager.disableDepth();
        GlStateManager.translate(-((double) shafferhack.textManager.getStringWidth(text) / 2.0), 0.0, 0.0);
        shafferhack.textManager.drawStringWithShadow(text, 0.0f, 0.0f, -5592406);
        GlStateManager.popMatrix();
    }
